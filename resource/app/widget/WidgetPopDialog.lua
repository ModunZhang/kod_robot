...
function WidgetPopDialog:ctor(height,title_text,y,title_bg, param)
    WidgetPopDialog.super.ctor(self, param)
    ...
    self.close_btn = WidgetPushButton.new({normal = "X_1.png",pressed = "X_2.png"})
        ...
        end):align(display.RIGHT_CENTER, title:getContentSize().width,title:getContentSize().height/2+2):addTo(title)
end
