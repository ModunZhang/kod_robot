...
function WidgetAllianceLanguagePanel:createCheckBoxButtons_()
	...
	local button = UICheckBoxButton.new(checkbox_image)
            :setButtonLabel(UIKit:ttfLabel({text = Language.es,size = 20,color = 0x797154}))
	...
	button = UICheckBoxButton.new(checkbox_image)
            :setButtonLabel(UIKit:ttfLabel({text = Language.pt,size = 20,color = 0x797154}))
            :setButtonLabelOffset(40, 0)
   ...
   table.insert(self.buttons_,button)
    button = UICheckBoxButton.new(checkbox_image)
            :setButtonLabel(UIKit:ttfLabel({text = Language.ko,size = 20,color = 0x797154}))
            :setButtonLabelOffset(40, 0)
	...
	table.insert(self.buttons_,button) 
    button = UICheckBoxButton.new(checkbox_image)
            :setButtonLabel(UIKit:ttfLabel({text = Language.ja,size = 20,color = 0x797154}))
            :setButtonLabelOffset(40, 0)
    ...
    table.insert(self.buttons_,button)
    button = UICheckBoxButton.new(checkbox_image)
            :setButtonLabel(UIKit:ttfLabel({text = Language.ru,size = 20,color = 0x797154}))
            :setButtonLabelOffset(40, 0)
    ...
    table.insert(self.buttons_,button)    
    button = UICheckBoxButton.new(checkbox_image)
            :setButtonLabel(UIKit:ttfLabel({text = Language.cn,size = 20,color = 0x797154}))
            :setButtonLabelOffset(40, 0)
    ...
    table.insert(self.buttons_,button)   
    button = UICheckBoxButton.new(checkbox_image)
            :setButtonLabel(UIKit:ttfLabel({text = Language.tw,size = 20,color = 0x797154}))
            :setButtonLabelOffset(40, 0)
    ...
    table.insert(self.buttons_,button)
	button = UICheckBoxButton.new(checkbox_image)
            :setButtonLabel(UIKit:ttfLabel({text = Language.de,size = 20,color = 0x797154}))
            :setButtonLabelOffset(40, 0)
    ...
    table.insert(self.buttons_,button)
    button = UICheckBoxButton.new(checkbox_image)
            :setButtonLabel(UIKit:ttfLabel({text = Language.all,size = 20,color = 0x797154}))
            :setButtonLabelOffset(40, 0)
    ...
    table.insert(self.buttons_,button)
	button = UICheckBoxButton.new(checkbox_image)
            :setButtonLabel(UIKit:ttfLabel({text = Language.en,size = 20,color = 0x797154}))
            :setButtonLabelOffset(40, 0)
    ...
    table.insert(self.buttons_,button)
    button = UICheckBoxButton.new(checkbox_image)
            :setButtonLabel(UIKit:ttfLabel({text = Language.fr,size = 20,color = 0x797154}))
            :setButtonLabelOffset(40, 0)
