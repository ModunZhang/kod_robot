--
-- Author: Kenny Dai
-- Date: 2016-03-03 10:56:03
--
local WidgetPushButton = import("..widget.WidgetPushButton")
local WidgetUIBackGround = import("..widget.WidgetUIBackGround")
local WidgetAllianceContribute = class("WidgetAllianceContribute", function ()
	local layer = display.newLayer()
    layer:setContentSize(cc.size(608, 788))
    layer:setNodeEventEnabled(true)
    return layer
end)
function WidgetAllianceContribute:ctor()
    ...
    local honour_bg = display.newScale9Sprite("back_ground_166x84.png",0 , 0,cc.size(138,34),cc.rect(15,10,136,64))
        :align(display.LEFT_CENTER, 30, 235):addTo(self)
    display.newSprite("honour_128x128.png"):align(display.CENTER, 30, 235):addTo(self):scale(42/128)
    ...
    local loyalty_bg = display.newScale9Sprite("back_ground_166x84.png",0 , 0,cc.size(138,34),cc.rect(15,10,136,64))
        :align(display.LEFT_CENTER, 200, 235):addTo(self)
    display.newSprite("loyalty_128x128.png"):align(display.CENTER, 205, 235):addTo(self):scale(46/128)
...
function WidgetAllianceContribute:CreateContributeGroup()
    local ui_self = self
    -- 透明背景框
    local group = WidgetUIBackGround.new({width = 568,height=490},WidgetUIBackGround.STYLE_TYPE.STYLE_6)
        :align(display.CENTER,304, 515):addTo(self)
    local group_table = {
        {
...
function WidgetAllianceContribute:GetDonateValueByType(donate_type)
...
function WidgetAllianceContribute:CreateContributeItem(params)
    -- 背景框
...
function WidgetAllianceContribute:onEnter()
...
function WidgetAllianceContribute:onExit()
...
function WidgetAllianceContribute:RefreashEff()
...
function WidgetAllianceContribute:IsAbleToContribute()
...
function WidgetAllianceContribute:OnUserDataChanged_allianceDonate()
    local donate = {
...
return WidgetAllianceContribute